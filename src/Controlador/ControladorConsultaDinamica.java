...
import DAO.DAOConsultaDinamica;
 ...
 * @author welvi
 */
public class ControladorConsultaDinamica {
    
    
private final DAOConsultaDinamica DAOConsultaDinamica;
private final ConsultaGemini consultaGemini;

public ControladorConsultaDinamica() {
    this.DAOConsultaDinamica = new DAOConsultaDinamica();
...
public List<Object[]> ejecutarConsultaNatural(String consultaNatural) {
        ...
        try {
            ...
            return DAOConsultaDinamica.ejecutarConsulta(sql);
        } catch (Exception e) {
    ...
    public String[] obtenerNombresColumnas(String consultaNatural) {
        ...
        try {
            ...
            return DAOConsultaDinamica.obtenerNombresColumnas(sql);
        } catch (Exception e) {
